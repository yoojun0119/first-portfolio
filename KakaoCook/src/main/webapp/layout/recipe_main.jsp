		...
		<header id="main_header">
			...
			<div id="header_login_section">
				<c:if test="${checkedMember == null }">
					<a href="login.do?url=recipe_main.do"><input type="button" value="로그인" style="cursor: pointer;"></a>
		...
		<section id="main_section">
			<article class="page">
				<div id="page1_contents">
					...
					<form action="recipe_category.do" name="search_form" method="post">
						<table>
							<tr>
								<td>대분류</td>
								<td>
				...
				<div id="page2_contents">
					<div id="recipe_header">
						...
						<form action="recipe_main.do" method="post">
							<select name="sortWay" onchange="submit()">
								<option value="latestSort" <c:if test="${sortWay == 'latestSort' }">selected</c:if>>최신순</option>
								<option value="mostSort" <c:if test="${sortWay == 'mostSort' }">selected</c:if>>조회순</option>
							</select>
						</form>
					</div>
					<div id="recipe_list">
